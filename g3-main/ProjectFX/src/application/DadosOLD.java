...
public class DadosOLD {
	...
	//METODO CONSTRUTOR
	public DadosOLD(String local, TipoLixo tipo_lixo, double toneladas_organico, double toneladas_madeira, double toneladas_tecido, double toneladas_papel, double energia_gerador, double energia_lixo, double energia_perdida, double area_vazao, double volume_agua, String comentario, Date dia)
	{
		this.local = local;
		this.tipo = tipo_lixo;
